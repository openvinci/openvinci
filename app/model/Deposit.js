...
Ext.define('APP.model.Deposit', {
    ...
    associations:[
        { type: 'hasMany', model: 'APP.model.DepositRow', name:'checkrows', foreignKey: 'partida', autoLoad:true }
    ],
    proxy: {
        type: 'rest',
        api: {
            create: 'data/deposit.php?action=create',
            read: 'data/deposit.php?action=read',
            update: 'data/deposit.php?action=update',
            destroy: 'data/deposit.php?action=destroy'
        },
        reader: {
            type: 'json',
            messageProperty: 'msg',
