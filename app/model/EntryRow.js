...
Ext.define('APP.model.EntryRow', {
    ...
    associations:[
        { type: 'belongsTo', model: 'APP.model.Entry', foreignKey: 'partida' }
    ],
    proxy: {
        type: 'rest',
        api: {
            create: 'data/entryRow.php?action=create',
            read: 'data/entryRow.php?action=read',
            update: 'data/entryRow.php?action=update',
            destroy: 'data/entryRow.php?action=destroy'
        },
        reader: {
            type: 'json',
            messageProperty: 'msg',
